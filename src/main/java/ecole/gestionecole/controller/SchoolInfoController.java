...
import ecole.gestionecole.dbController.SchoolController;
import ecole.gestionecole.model.School;
...
public class SchoolInfoController implements Initializable {
    ...
    void printDetails(ActionEvent event) {
        try {
            ...
            InputStream report = getClass().getResourceAsStream("/ecole/gestionecole/other/Reports/SchoolInfo.jrxml");
