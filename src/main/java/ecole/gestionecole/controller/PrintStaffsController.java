...
import ecole.gestionecole.tableModel.StaffTableModel;
...
public class PrintStaffsController implements Initializable {
    ...
    void Back() {
        try {
            AnchorPane studentMgmt = FXMLLoader.load(HelloApplication.class.getResource(("StaffManagement.fxml")));
    ...
    void print(ActionEvent event) {
        ...
        try {
            ...
            InputStream report1 = getClass().getResourceAsStream("/ecole/gestionecole/other/Reports/StaffList.jrxml");
            InputStream report2 = getClass().getResourceAsStream("/ecole/gestionecole/other/Reports/StaffListPast.jrxml");

            JRDesignQuery query = new JRDesignQuery();

          /*  HashMap<String,Object> Logo = new HashMap<String, Object>();

            URL url = this.getClass().getClassLoader().getResource("sms/other/img/logo.jpg");
            Logo.put("logo", url);*/
