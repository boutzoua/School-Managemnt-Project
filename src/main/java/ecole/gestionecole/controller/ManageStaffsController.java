...
import ecole.gestionecole.dbController.StaffController;
import ecole.gestionecole.model.Staff;
...
public class ManageStaffsController implements Initializable {
    ...
    void printStaff(ActionEvent event) {
        try {
            ...
            InputStream report1 = getClass().getResourceAsStream("/ecole/gestionecole/other/Reports/StaffInfo.jrxml");
            InputStream report2 = getClass().getResourceAsStream("/ecole/gestionecole/other/Reports/StaffInfoPast.jrxml");
