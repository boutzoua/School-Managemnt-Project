...
import ecole.gestionecole.dbController.GradeController;
import ecole.gestionecole.tableModel.StudentTableModel;
...
public class PrintStudents2Controller implements Initializable {
    ...
    void printStudents(ActionEvent event) {
        ...
        try {
            ...
            Connection conn = DBConnection.getDBConnection().getConnection();
            InputStream report1 = getClass().getResourceAsStream("/ecole/gestionecole/other/Reports/StudentList.jrxml");
            InputStream report2 = getClass().getResourceAsStream("/ecole/gestionecole/other/Reports/StudentListGender.jrxml");
            InputStream report3 = getClass().getResourceAsStream("/ecole/gestionecole/other/Reports/PastStudentList.jrxml");
            InputStream report4 = getClass().getResourceAsStream("/ecole/gestionecole/other/Reports/PastStudentListGender.jrxml");
